<div class="col-md-3" id="mysidebar">
    ...
    <div class="d-flex align-items-center flex-column">
        <img src="{{url(route('avatar',['cin'=>Auth::user()->image]))}}" class="rounded-circle p-3" height="150" alt=""
            />
        <h5 class=""><span name=" side-item-label"><strong><span name="side-item-label">{{ Auth::user()->first_name }} {{ ' ' }}
    ...
    @foreach ($items as $item)
        ...
        <div class="border-top pt-2 row">
            <span  name="side-item-label"><h6>{{$item['title']}}</h6></span>
        </div>
        @else
            @if ($item['expanded'])
