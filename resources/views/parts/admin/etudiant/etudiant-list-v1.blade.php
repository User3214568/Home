<script src="/javascript/upload-export.js"></script>
    ...
    <div class="p-4 d-flex justify-content-around">
        ...
        <a id="btn-export" type="button" class="btn btn-info btn-rounded" href="{{route('etudiant.export')}}">
    ...
    <form  class="border p-4 col d-flex flex-column justify-content-center" method="post" action="{{route('etudiant.import')}}" enctype="multipart/form-data" >
        @csrf
